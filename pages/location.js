            ...
            <InnerCol>
              <TextSection>
                ...
                <p className="text-body">
                  Hudson Square is situated between the Hudson River and Avenue of the Americas, from Houston Street to
                  Canal Street. Once known as New York City’s Printing District, this tiny pocket of enormous 19th- and
                  early 20th-century former printing houses has evolved alongside the publishing industry. Today all
                  that old-school architecture houses an impressive array of high-profile media, advertising and
          ...
          <MainCol id="section-neighborhood-soho">
            ...
            <InnerCol>
              <TextSection>
                ...
                <p className="text-body">
                  The storied area east of Avenue of the Americas, between Houston and Canal streets, was dubbed Soho in
                  the early 1970s, when it emerged as an art mecca. Today all these historic Queen Anne and cast-iron
                  buildings house more high-end clothing stores than artists’ lofts, but the creative spirit of this
                  former art mecca lives on. Top-tier makers in beautifully designed spaces draw ever-revolving crowds
                  who spark with new ideas and perspectives.
                </p>
              </TextSection>
