      ...
      context.state.windowDimensions.width > 1024 ? (
        ...
        <div>
          ...
          <Heading bold>
            ...
            Management with Hines, the operating partner, of a 12 building portfolio of approximately 6 million rentable
            square feet.
          </Heading>
          ...
          <MainCol>
            <InnerCol>
              ...
              <TextSection>
                <p className="text-body">
                  ...
                  Benchmark (GRESB), which assesses the sustainability performance of leading real estate portfolios and
                  assets worldwide. Assessment participants receive comparative business intelligence on where they
                  stand against their peers, a roadmap with the actions they can take to improve their Environmental
                  Social and Governance performance and a communication platform to engage with investors.
                  <br />
                  ...
                  <br />
                  <br /> Individual Building Sustainability and Energy Efficiency Accomplishments 75 Varick Street: LEED
                  Silver certified, LEED Gold certification in progress 345&nbsp;Hudson&nbsp;Street: LEED Gold
                  certification
                </p>
              </TextSection>
            </InnerCol>
            <InnerCol>
              ...
              <TextSection>
                <p className="text-body">
                  Trinity Church Wall Street has played a prominent role in lower Manhattan for more than 300 years. Its
                  history in the Hudson Square neighborhood dates back to the generous land grant given to the church by
                  Queen Anne in 1705. Today, Trinity owns 14 acres in the vibrant and growing neighborhood, property
                  that continues to provide resources for the church’s mission and ministries in New York City and
                  around the world.
                  <br />
                  <br />
              ...
              <ResponsiveImage srcPath="/static/images/story/2_Hudson_Square/bg-story-hudson-square-right" imgAlt="" />
            </InnerCol>
          </MainCol>
            ...
            <InnerCol>
              ...
              <TextSection>
                ...
                <p className="text-body">
                  ...
                  compassion, social justice, and stewardship. Members come from the five boroughs of New York City and
                  surrounding areas to form a racially, ethnically, and economically diverse congregation. More than 20
                  worship services are offered every week at its historic sanctuaries, Trinity Church and St. Paul’s
                  Chapel, the cornerstones of the parish’s community life, worship, and mission, and online at &nbsp;
          ...
          <MainCol>
            <InnerCol>
              ...
              <TextSection>
                ...
                <p className="text-body">
                  Norges Bank Real Estate Management manages approximately $27 billion in direct real estate investments
                  on behalf of the Norwegian Government Pension Fund Global, totaling $1,020 billion of assets across
                  equity, fixed income and real estate. The fund’s mission is to safeguard financial wealth for future
                  generations. Norges Bank Real Estate Management continues to invest in three target asset classes –
                  office, retail and logistics. Investments in office and retail are focused across a limited number of
                  global cities in Europe, the US and Asia that have key fundamentals including transparency, liquidity,
          ...
          <MainCol>
            <InnerCol>
              ...
              <TextSection>
                <p className="text-body">
                  The firm’s current property and asset management portfolio includes 527 properties, representing over
                  224 million square feet. With extensive experience in investments across the risk spectrum and all
                  property types, and a pioneering commitment to sustainability, Hines is one of the largest and
        ...
        <div>
          ...
          <MainCol>
            <InnerCol>
              ...
              <ResponsiveImage srcPath="/static/images/story/2_Hudson_Square/bg-story-hudson-square-mobile" imgAlt="" />
            ...
            <InnerCol>
              ...
              <TextSection>
                ...
                <p className="text-body">
                  ...
                  office, retail and logistics. Investments in office and retail are focused across a limited number of
                  global cities in Europe, the US and Asia that have key fundamentals including transparency, liquidity,
                  supply restrictions and the potential for economic growth. Investments in logistics are located across
                  Europe and the US with a strategic focus on proximity to large metropolitan markets and key global
                  distribution networks. The fund owns direct real estate investments totaling nearly 800 assets across
                  13 countries. In the US, the fund owns direct real estate investments across 22 million square feet of
                  office and retail properties in New York City, Boston, Washington DC and San Francisco. Visit&nbsp;
                  <a href="https://www.nbim.no/" target="_blank" rel="noopener noreferrer">
                    https://www.nbim.no/
                  </a>
                  &nbsp;for more information.
            ...
            <InnerCol>
              ...
              <TextSection>
                ...
                <p className="text-body">
                  ...
                  experience in investments across the risk spectrum and all property types, and a pioneering commitment
                  to sustainability, Hines is one of the largest and most-respected real estate organizations in the
                  world. Visit&nbsp;
                  <a target="_blank" rel="noopener noreferrer" href="https://www.hines.com/">
                    www.hines.com
                  </a>
