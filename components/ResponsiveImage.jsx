  ...
  render() {
    return (
      <ResponsiveImageContainer
        ...
        srcSet={`${this.props.srcPath}_400.jpg 400w, ${this.props.srcPath}_600.jpg 600w, ${
          this.props.srcPath
        }_800.jpg 800w, ${this.props.srcPath}_1100.jpg 1100w, ${this.props.srcPath}_1500.jpg 1500w, ${
          this.props.srcPath
