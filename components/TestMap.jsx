...
//           }}
//           label={{ color: '#000000', fontWeight: 'bold', fontSize: '12px', text: el.name }}
//         >
...
//   render() {
//     const { center, neighborhood } = this.state;
...
//           fillColor="#369BF7"
//           zIndex={50}
//           visible={neighborhood.westVillage ? 1 : 0}
//         />
//         <Polygon
//           paths={[
//             { lat: 40.7290705, lng: -74.0105223 },
...
//           zIndex={100}
//           onMouseover={() => {
//             this.toggleNeighborhoodVisibility('westVillage');
//           }}
//           onMouseout={() => {
//             this.toggleNeighborhoodVisibility('westVillage');
//           }}
...
//           visible={neighborhood.westVillage}
//         />
//         <Polygon
//           paths={[
...
//           }}
//           onMouseover={() => {
//             this.toggleNeighborhoodVisibility('tribeca');
//           }}
//           onMouseout={() => {
//             this.toggleNeighborhoodVisibility('tribeca');
//           }}
...
//           }}
//           onMouseover={() => {
//             this.toggleNeighborhoodVisibility('hudsonSquare');
//           }}
//           onMouseout={() => {
//             this.toggleNeighborhoodVisibility('hudsonSquare');
//           }}
...
//           }
//           onMouseover={() => {
//             this.toggleNeighborhoodVisibility('soho');
//           }}
//           onMouseout={() => {
//             this.toggleNeighborhoodVisibility('soho');
//           }}
//         />
//         {activeFilter === 'Our Buildings' ? this.generateBuildings() : ''}
//       </Map>
//     );
//   }
// }
...
//   apiKey: 'AIzaSyBSsLXxJ5NSrSgFjFW7U5hxmGyHnE1po88'
// })(GoogleMap);
