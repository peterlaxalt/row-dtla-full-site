...
//     'ChIJZRslaJRZwokRgVlMzbgFTus': { position: { lat: 40.7343945, lng: -74.0027101 }, name: 'While We Were Young Kitchen & Cocktails'},
//     'ChIJja0-KpdZwokRuOHSWneCBxE': { position: { lat: 40.732629, lng: -73.99766799999998 }, name: 'Amelie Wine Bar'},
//     'ChIJt_loX5JZwokRZkK8Zu2O_X4': { position: { lat: 40.72981679999999, lng: -74.00351599999999 }, name: 'Jack\'s Wife Freda'},
//     'ChIJN03iU5RZwokR84lClGFMbTo': { position: { lat: 40.7354258, lng: -74.00314100000003 }, name: 'Sant Ambroeus West Village'},
//     'ChIJiU1zGvNZwokRRmxoONWMGnc': { position: { lat: 40.7260206, lng: -74.00846899999999 }, name: 'Giorgione'},
//     'ChIJS7q7to1ZwokRWbN1t_AXYME': { position: { lat: 40.72609200000001, lng: -74.00240819999999 }, name: 'Blue Ribbon Sushi'},
...
//     'ChIJPRCpXpRZwokRtFAFKuIuG7M': { position: { lat: 40.73476259999999, lng: -74.00323759999998 }, name: 'Mary\'s Fish Camp'},
...
//     'ChIJke-X5L9ZwokRvFn8bmeiNBs': { position: { lat: 40.7389011, lng: -74.00567960000001 }, name: 'High Street on Hudson'},
...
//   },
//   'GRAB & GO FOOD': {
//     'ChIJm5EYP41ZwokR57_u5F4y4Us': { position: { lat: 40.727230, lng: -74.005255 }, name: 'Little Italy Pizzeria & Deli' },
//     'ChIJQfLbt_JZwokR5CgFbFPo0Fo': { position: { lat: 40.7275431, lng: -74.00707510000001 }, name: 'Hale and Hearty Soups'},
//     'ChIJ9wkmyPJZwokRINn2zgV3Xvg': { position: { lat: 40.72782400000001, lng: -74.00704300000001 }, name: 'Dig Inn'},
//     'ChIJIbitGJJZwokR9VenUP8f_0E': { position: { lat: 40.7292098, lng: -74.00101689999997 }, name: 'by CHLOE. West Village'},
//     'ChIJbVjFt_JZwokRWHeKp3VkJeA': { position: { lat: 40.72766470000001, lng: -74.00678449999998 }, name: 'Pret A Manger'},
//     'ChIJk0szpPJZwokRQ0Tuv1t1N34': { position: { lat: 40.7284824, lng: -74.00791879999997 }, name: 'Le Pain Quotidien'},
//     'ChIJpSE_JI1ZwokRaYoe_vePq6w': { position: { lat: 40.72655479999999, lng: -74.0053714 }, name: 'Essen Fast Slow Food'},
...
//     'ChIJp4eoppJZwokRpJ6QCjck6I0': { position: { lat: 40.72900309999999, lng: -74.00563039999997 }, name: 'Getting Hungry'},
//   },
//   'EVENT SPACES': {
//     'ChIJ84m3kPRZwokROFqq5MahX0Q': { position: { lat: 40.7234427, lng: -74.00834909999998 }, name: 'Tribeca Rooftop'},
//     'ChIJqUo0iZJZwokRz3Kh2odq2rU': { position: { lat: 40.7293723, lng: -74.00418150000002 }, name: 'Alger House in the Village'},
//     'ChIJcVNgxo1ZwokRMIgLMm_S2Es': { position: { lat: 40.7264492, lng: -74.00179800000001 }, name: 'The Lofts at Prince'},
//     'ChIJTX6hP5NZwokRy2zpDDqtNvs': { position: { lat: 40.73737759999999, lng: -74.00175050000001 }, name: 'Little Owl The Venue'},
//     'ChIJp2ElgJNZwokRaQGaYtRF4d4': { position: { lat: 40.73318920000001, lng: -74.0035317 }, name: 'Little Owl The Townhouse'},
//     'ChIJzzax34tZwokR8OTNZljyN0I': { position: { lat: 40.7217054, lng: -74.0008082 }, name: 'Soho Lofts'},
//     'ChIJpbfBMopZwokRxQO9o47tUI0': { position: { lat: 40.72054, lng: -74.00134100000002 }, name: 'The Farm SoHo - Coworking Office Space NYC'},
...
//     'ChIJ2a47oB9awokRj5umaLKRd1s': { position: { lat: 40.71673990000001, lng: -74.0080577 }, name: 'Tiny\'s & The Bar Upstairs'},
...
//     'ChIJZQELoYxZwokR-y4Vo_dVctI': { position: { lat: 40.7237873, lng: -74.00508530000002 }, name: 'Artifakt Bar and Lounge'},
...
//     'ChIJd8khjJJZwokRPx0UD3pEMuE': { position: { lat: 40.72936569999999, lng: -74.00378969999997 }, name: 'Blue Ribbon Downing Street Bar'},
...
//     'ChIJ_-JwoItZwokRoptvAsv5Waw': { position: { lat: 40.72216249999999, lng: -74.00348919999999 }, name: 'Lucky Strike'},
...
//     'ChIJX5URYPNZwokRlEaFrdshgP4': { position: { lat: 40.7244354, lng: -74.00806899999998 }, name: 'Arlo Roof Top (A.R.T.)'},
...
//     'ChIJfeW5nZJZwokRxFwjLpeBhrk': { position: { lat: 40.72871529999999, lng: -74.00457799999998 }, name: 'The Brooklyneer'},
...
//     'ChIJXTz9tfJZwokRVOEBKxnSGQY': { position: { lat: 40.72766470000001, lng: -74.00678449999998 }, name: 'Gregorys Coffee'},
//     'ChIJ2cijhR9awokRQBdGxQzz0wQ': { position: { lat: 40.7169103, lng: -74.00675939999996 }, name: 'Arcade Bakery'},
//     'ChIJ0wOsOZRZwokRY1t9B6VG3e8': { position: { lat: 40.7348028, lng: -74.00189390000003 }, name: 'Dominique Ansel Kitchen'},
...
//     'ChIJ1fPJMu1ZwokR9bAptiISZfs': { position: { lat: 40.7305602, lng: -74.00653410000001 }, name: 'Merriweather Coffee + Kitchen'},
//     'ChIJ9Tr8spNZwokRK7Th-8nYiQs': { position: { lat: 40.7308397, lng: -74.00264249999998 }, name: 'Pasticceria Rocco'},
//     'ChIJM767a4xZwokRXyq8NCoE33I': { position: { lat: 40.7243185, lng: -74.00230479999999 }, name: 'Ladurée New York Soho'},
...
//   },
//   'RETAIL': {
//     'ChIJv_keOY1ZwokRlNuvMTH8bkw': { position: { lat: 40.727521, lng: -74.005190 }, name: 'ARROJO Studio Soho'},
//     'ChIJK4-sv_RZwokR_-YWAnNmIls': { position: { lat: 40.7229375, lng: -74.00782090000001 }, name: 'ARROJO Studio TriBeCa'},
...
//     'ChIJZ-a2kI5ZwokRjwGGZ7bLypo': { position: { lat: 40.72463250000001, lng: -73.99998449999998 }, name: 'DIOR Soho Store'},
//     'ChIJmXAB1o1ZwokRxo0dH1kgHfU': { position: { lat: 40.725784, lng: -74.00069480000002 }, name: 'Coach'},
//     'ChIJq6reMIxZwokRuz27w0YZqO4': { position: { lat: 40.72510510000001, lng: -74.00172099999997 }, name: 'KARL LAGERFELD'},
//     'ChIJO5XMjY5ZwokRXZ8XCiVL9aA': { position: { lat: 40.7247415, lng: -73.99936079999998 }, name: 'Louis Vuitton New York SoHo'},
//     'ChIJoWf_go5ZwokR849wL5oCSw8': { position: { lat: 40.7250048, lng: -74.00056760000001 }, name: 'Ted Baker SoHo'},
//     'ChIJxzJcc4xZwokRCosButOyGl8': { position: { lat: 40.72519599999999, lng: -73.99939999999998 }, name: 'Polo Ralph Lauren'},
//     'ChIJc4J-H4xZwokRRkoSIYHI830': { position: { lat: 40.7242622, lng: -74.00083919999997 }, name: 'CHANEL New York Soho'},
...
//   },
//   'HEALTH + FITNESS': {
//     'ChIJxQfx-4xZwokR39Iby7aaIiI': { position: { lat: 40.725840, lng: -74.004285 }, name: 'CVS Pharmacy'},
...
//     'ChIJqbkiw_JZwokRusfU4MtLto8': { position: { lat: 40.727165, lng: -74.007692 }, name: 'Real Pilates - (Hudson Square)'},
//     'ChIJYzd3_YxZwokRP_JqqpyHKRs': { position: { lat: 40.726110, lng: -74.003495 }, name: 'Physique 57'},
...
//     'ChIJnUkYY4tZwokReW2LpghyQ0I': { position: { lat: 40.7171015, lng: -74.00680019999999 }, name: 'NYC Elite Gymnastics'},
//     'ChIJY30kFe1ZwokRiHlkAvLc12M': { position: { lat: 40.730222, lng: -74.00795319999997 }, name: 'SoulCycle - West Village'},
//     'ChIJN1WPxJNZwokR6jWhU3ee4zc': { position: { lat: 40.7314306, lng: -74.00147620000001 }, name: 'CityMD West Village'},
...
//     'ChIJG5_ZTo1ZwokRYO2dYyekiQk': { position: { lat: 40.727830, lng: -74.005976 }, name: 'Geary Contemporary'},
//     'ChIJBaxdorhZwokR09a9ldotesc': { position: { lat: 40.718939, lng: -74.0036996 }, name: 'Alexander and Bonin'},
//     'ChIJW-84fIpZwokR8Eh2JD2QKkk': { position: { lat: 40.718826, lng: -74.00332579999997 }, name: 'Artists Space Books & Talks'},
//     'ChIJL__x3YlZwokRWkmi33szuw8': { position: { lat: 40.7182131, lng: -73.9990856 }, name: 'The Camera Club of New York'},
...
//     'ChIJz83U3vJZwokRwHuQbIh8-yY': { position: { lat: 40.7268741, lng: -74.00775920000001 }, name: 'Kate Werble Gallery'},
...
//     'ChIJXWJZyYtZwokROFkwxSs1ZJE': { position: { lat: 40.72111820000001, lng: -74.00190299999997 }, name: 'Ronald Feldman Gallery'},
//     'ChIJeaNd3IhZwokRU25epwuJ4aY': { position: { lat: 40.7214782, lng: -73.99707089999998 }, name: 'Storefront for Art and Architecture'},
//     'ChIJDTWukItZwokREUciPmdlVy0': { position: { lat: 40.72244610000001, lng: -74.00295729999999 }, name: 'The Drawing Center'},
//     'ChIJ7ylTgiBawokRk5BP2BzEJ2E': { position: { lat: 40.7170321, lng: -74.0030557 }, name: 'The National Exemplar Gallery'},
//     'ChIJWaqbDolZwokRWK8vbWSAfMk': { position: { lat: 40.7276164, lng: -74.00815439999997 }, name: 'Children\'s Museum of the Arts'},
//     'ChIJsblxMfNZwokRBLOhQZRjwtE': { position: { lat: 40.7255619, lng: -74.006935 }, name: 'New York City Fire Museum'},
//     'ChIJIwbwb45ZwokRbUztx3kE1IY': { position: { lat: 40.7261985, lng: -73.99958049999998 }, name: 'Walter de Maria: The New York Earth Room'},
//   },
...
//     'ChIJQ1RTt49ZwokRgYgqG6DdK2w': { position: { lat: 40.7259225, lng: -73.9973541 }, name: 'Angelika Film Center & Café - New York'},
...
//     'Eh1NaW5ldHRhIExuLCBOZXcgWW9yaywgTlksIFVTQSIuKiwKFAoSCbExKCqSWcKJEX6uF20ge-JeEhQKEgk7CD_TpU_CiRFi_nfhBo8LyA': { position: { lat: 40.73025679999999, lng: -74.00102559999999 }, name: 'Minetta Lane'},
//     'ChIJm0HEXpNZwokR8-qsn35JqBo': { position: { lat: 40.7332808, lng: -74.00571919999999 }, name: 'Lucille Lortel Theatre'},
//     'EiJCYXJyb3cgU3QsIE5ldyBZb3JrLCBOWSAxMDAxNCwgVVNBIi4qLAoUChIJZTMfNpNZwokRwUDWgIMvNV4SFAoSCTsIP9OlT8KJEWL-d-EGjwvI': { position: { lat: 40.731644, lng: -74.00600509999998 }, name: 'Barrow Street'},
//     'ChIJaSATiIpZwokRPrpfx9FD-uw': { position: { lat: 40.719313, lng: -74.00352699999996 }, name: 'Soho Rep.'},
//     'ChIJiextKI1ZwokRKTNKS2BGVRs': { position: { lat: 40.726232, lng: -74.0060077 }, name: 'City Winery'},
//     'ChIJMbfknu5ZwokRaRXuCuQIWmE': { position: { lat: 40.73303629999999, lng: -74.01100509999998 }, name: 'Pier 45 at Hudson River Park'},
//     'ChIJRfP4AqNZwokRDsAFGNO1bbI': { position: { lat: 40.7355734, lng: -74.00199909999998 }, name: 'Idlewild Books'},
//   },
...
//     'ChIJuXvxrZNZwokR3XPZK9SvN-U': { position: { lat: 40.73102360000001, lng: -74.00309709999999 }, name: 'Murray\'s Cheese'},
//     'ChIJ1csLDO1ZwokRiPwnF5nU3bU': { position: { lat: 40.7307358, lng: -74.00916870000003 }, name: 'Le Du\'s Wines'},
//     'ChIJty_d1exZwokRbGd_NAo-lYk': { position: { lat: 40.7314316, lng: -74.0068339 }, name: 'Golden Rule Wine & Liquor'},
//     'ChIJFZvam5RZwokRFTN9DvQICqs': { position: { lat: 40.73386800000001, lng: -74.00472819999999 }, name: 'Village Apothecary'},
...
//     var position = new google.maps.LatLng(neighborhoodLabelData.positionData.lat, neighborhoodLabelData.positionData.lng);
...
//   }
//   return (
//     '<div class="number-rating">' + place.rating + '</div>' +
...
//         var bgImg = (place.photos && place.photos.length) ? place.photos[0].getUrl({'maxWidth': 273.44, 'maxHeight': 180}) : '';
//         var parsedPlace = {
//           id: placeId,
//           category: category,
//           position: {
