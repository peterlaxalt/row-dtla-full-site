const buildings = [
  ...
  },
  {
    ...
    CeilingHeights: ['12′-4″'],
    aboout: '160 Varick Street is conveniently situated in the heart of Hudson Square, between Charlton and Vandam Streets and close to the no.1, A, C and E subway stations. The building has an industrial history, as evidenced by its structure, large windows and high, loft-like ceilings. A newly renovated lobby designed by Studios Architecture, opened in the fall of 2018 featuring soft seating and rotating art installations. 160 Varick Street is home to WeWork and New York Public Radio.',
    header: {
  ...
  },
  {
    ...
    about: '345 Hudson Street occupies the entire block between King and Charlton Streets, with over 980,000 square feet across 17 stories. The property is conveniently located a short walk from the no.1 Houston Street subway station and Hudson River Park in the heart of Hudson Square. With floors averaging 60,000 square feet, the building creates a welcoming environment for media and communication tenants. Notable tenants include Viacom, CBS, Google, Hines & Daniel Wellington.',
    header: {
  ...
  },
  {
    ...
    about: 'Built in 1929, 155 Avenue of the Americas sits directly across from the newly re-opened Spring Street Park in Soho and is adjacent to the Spring Street station of the A, C and E subway lines. With floorplates of approximately 12,500 – 15,300 square feet, 155 Avenue of the Americas provides a boutique offering to smaller tenants looking for a full floor presence, especially desirable for creative and technology industries. A newly renovated building lobby designed by the architectural firm A+I, features rotating art exhibition, and a roof deck amenity will be open to all tenants in 2019. Soho favorite Café Altro Paradiso and Ducati occupy the ground level retail spaces. Office tenants include Accenture, New York University and Downtown Music Publishing.',
    header: {
